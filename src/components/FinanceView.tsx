      ...
      <div className="bg-gradient-to-r from-amber-500/10 via-emerald-500/10 to-indigo-500/10 border border-amber-300/60 p-4 rounded-2xl space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
          <div className="bg-white p-3 rounded-xl border border-slate-200 shadow-2xs">
            ...
            <div className="text-sm font-black text-emerald-700 mt-0.5">Rp 40.000 / pertemuan</div>
          ...
          <div className="bg-white p-3 rounded-xl border border-slate-200 shadow-2xs">
            ...
            <div className="text-sm font-black text-indigo-700 mt-0.5">Rp 35.000 / pertemuan</div>
          ...
          <div className="bg-white p-3 rounded-xl border border-emerald-300 bg-emerald-50/50 shadow-2xs">
            ...
            <div className="text-sm font-black text-amber-600 mt-0.5">Rp 5.000 / pertemuan (12.5%)</div>
