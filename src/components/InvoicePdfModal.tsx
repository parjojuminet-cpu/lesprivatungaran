      ...
      <div className="bg-white rounded-2xl max-w-3xl w-full my-auto shadow-2xl overflow-hidden border border-slate-200 flex flex-col max-h-[92vh]">
        ...
        <div className="p-6 sm:p-8 overflow-y-auto space-y-6 text-slate-800 bg-white" ref={printRef} id="printable-invoice">
          ...
          <div className="pt-3 border-t-2 border-dashed border-slate-200">
            <div className="bg-gradient-to-r from-emerald-50 via-slate-50 to-indigo-50 rounded-2xl p-4 flex flex-col items-center justify-center gap-4 border border-slate-100 shadow-3xs">
              <div className="flex flex-col items-center text-center space-y-2 w-full">
                <span className="text-xs sm:text-sm font-extrabold text-indigo-700 tracking-wider uppercase">Hubungi &amp; Ikuti Kami</span>
                <div className="flex flex-wrap gap-3.5 justify-center items-center w-full">
                  ...
                  <a
                    ...
                    className="flex items-center gap-2 bg-white hover:bg-slate-50 px-4 py-2 rounded-full border border-slate-200 text-xs sm:text-[13px] font-bold text-slate-700 shadow-2xs transition-colors"
                  >
