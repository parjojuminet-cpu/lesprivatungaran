...
export const ReportsView: React.FC<ReportsViewProps> = ({
  ...
  const handleSendReportWA = () => {
    ...
    msg += `✅ Total Pertemuan Hadir: ${totalSessionsAttended} Sesi\n`;
    msg += `📩 Total Izin: ${totalPermissions} Sesi\n`;
    msg += `📌 Sisa Paket Belajar: ${selectedStudent.remainingSessions} Sesi\n\n`;
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 cursor-pointer"
            >
              <option value="SEMUA">Semua Bulan (Keseluruhan Sesi)</option>
          ...
          <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <div className="bg-indigo-50/70 p-4 rounded-2xl border border-indigo-100/80">
                ...
                <div className="text-xl font-black text-indigo-950">{totalSessionsAttended} Sesi</div>
              ...
              <div className="bg-amber-50/70 p-4 rounded-2xl border border-amber-100/80">
                <div className="flex items-center justify-between text-amber-700 mb-1">
                  <span className="text-[11px] font-bold">Izin / Reschedule</span>
                  <Calendar className="w-4 h-4 text-amber-600" />
                </div>
                <div className="text-xl font-black text-amber-950">{totalPermissions} Sesi</div>
              ...
              <div className="bg-emerald-50/70 p-4 rounded-2xl border border-emerald-100/80">
                ...
                <div className="text-xl font-black text-emerald-950">{selectedStudent.remainingSessions} Sesi</div>
                <div className="text-[10px] text-emerald-600 font-medium mt-0.5">Dari Total {selectedStudent.totalPackageSessions} Sesi</div>
              </div>
            ...
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <div className="flex items-center gap-2">
                ...
                <h4 className="font-extrabold text-slate-900 text-sm">
                  Jurnal Belajar & Catatan Perkembangan Sesi
                </h4>
              </div>
