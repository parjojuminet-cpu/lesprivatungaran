...
export type AttendanceStatus = 'Hadir' | 'Izin H-1' | 'Izin Mendadak' | 'Force Majeure' | 'Alpha';

export type ApprovalType = 'Force Majeure' | 'Izin Mendadak' | 'Over-Limit Reschedule' | 'Tarif Non-Standar';
